...
contract PriceAutomation is AutomationCompatible {
    ...
    // TODO: Lấy giá trực tiếp qua contract pool. sử dụng priceFeed để lấy các tỉ giá khác để convert, hoặc có thể bỏ luôn priceFeed
    ...
    function getAllPrices() external view returns (uint256[] memory timestamps, int256[] memory prices) {
        ...
        uint256 index = 0;
        // TODO: using mapping timestamp -> price, not the index i.
